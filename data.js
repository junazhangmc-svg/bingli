 ...
 * ---- 情境层，全部可选 ----
 * hi/lo 偏高 / 偏低的常见原因，按「常见 → 少见」排，只在对应方向真的偏了才显示
 * dept  这项异常时通常挂哪个科
 *
 * 【hi / lo 的三条硬规矩】
 *   1. 只在有对应阈值时写 —— 没有 max 就别写 hi，没有 min 就别写 lo。
 *      judge() 判不出方向，写了也永远显示不出来，是死数据。
 *   2. 按「常见 → 少见」排，第一条必须是最平常的解释。
 *      把「白血病」摆在「最近感冒」前面，是在吓人，不是在帮人。
 *   3. 这是「常见原因」不是「诊断」。措辞一律留余地，
 *      任何一条都不能读成「你得了这个病」。
 * ------------------------------------------------------------------------ */
var IND = [
...
{ k:"lipid_tc", n:"总胆固醇", cat:"血脂", spec:"serum",
  ...
  max:5.2, t:"< 5.2",
  hi:["饮食偏油、运动少、体重上升","家族性高胆固醇（一家人都高、从年轻就高）",
      "甲状腺功能减退时会连带升高","肾病综合征等丢蛋白的情况"],
  dept:["心血管内科","内分泌科"],
  g:"q", forDis:["hlp","cad","dm","fld","hypo"] },
...
{ k:"lipid_tg", n:"甘油三酯", cat:"血脂", spec:"serum",
  ...
  max:1.7, t:"< 1.7",
  /* 第一条真的就是最常见的原因，先排除它再谈别的 */
  hi:["抽血前没有真正空腹，或前一晚吃得油","近期饮酒","体重、腰围上升，胰岛素抵抗",
      "血糖控制不好时常一起升高","很高（＞5.6）时要注意胰腺炎风险，尽快就医"],
  dept:["心血管内科","内分泌科"],
  g:"q", forDis:["hlp","dm","fld","gout"] },
...
{ k:"lipid_hdl_c", n:"高密度脂蛋白 HDL-C", cat:"血脂", spec:"serum",
  ...
  lo:["久坐、缺乏有氧运动","吸烟","甘油三酯高时它往往同时偏低","体质因素，部分人天生偏低"],
  dept:["心血管内科"],
...
{ k:"lipid_ldl_c", n:"低密度脂蛋白 LDL-C", cat:"血脂", spec:"serum",
  ...
  hi:["饮食中饱和脂肪偏多（肥肉、动物油、奶油、油炸）","运动少、体重上升",
      "在吃的降脂药停了或减量了","家族性高胆固醇（从年轻就高、家里多人高）",
      "甲状腺功能减退时会连带升高"],
  dept:["心血管内科","内分泌科"],
  g:"q", forDis:["hlp","cad","dm"] },
...
{ k:"lipid_apob", n:"载脂蛋白 B", cat:"血脂", spec:"serum",
  ...
  max:1.0, t:"< 1.0",
  hi:["和 LDL 同向升高，原因基本一样","LDL 已达标但它仍高，说明颗粒数偏多、风险被低估了，值得跟医生提一句"],
  dept:["心血管内科"],
  g:"q", forDis:["hlp","cad","dm"] },
...
{ k:"lipid_lpa", n:"脂蛋白 a", cat:"血脂", spec:"serum",
  ...
  max:300, t:"< 300",
  /* 这条要特别小心措辞：它高了基本没法靠生活方式降，说「少吃油」是误导 */
  hi:["由基因决定，和饮食运动关系不大，改生活方式基本降不下来",
      "它高意味着其他可控因素（LDL、血压、吸烟）要压得更严",
      "值得让直系亲属也查一次"],
  dept:["心血管内科"],
  g:"n", forDis:["hlp","cad"] },
...
{ k:"lipid_apoa1", n:"载脂蛋白 A1", cat:"血脂", spec:"serum",
  ...
  min:1.0, t:"> 1.0",
  lo:["通常和 HDL 一起低，原因相同：久坐、吸烟、甘油三酯高","慢性肝病时合成减少"],
  dept:["心血管内科"],
  g:"q", forDis:["hlp","cad"] },
...
{ k:"lipid_sdldl", n:"小而密低密度脂蛋白 sdLDL-C", cat:"血脂", spec:"serum",
  ...
  /* 没有 min/max，judge 永远判不出方向，所以刻意不写 hi/lo（写了也是死数据）。
     dept 与判读无关，照给。 */
  dept:["心血管内科"],
  g:"n", forDis:["hlp","cad"] },
...
{ k:"glucose_fasting", n:"空腹血糖", cat:"血糖", spec:"plasma",
  ...
  min:3.9, max:6.1, t:"3.9 – 6.1",
  hi:["抽血前其实没空腹够 8 小时（先确认这条）","糖尿病前期或糖尿病",
      "近期感染、外伤、手术等应激状态","在用糖皮质激素等升糖的药"],
  lo:["抽血前空腹太久（超过 12 小时）","在用降糖药或胰岛素，剂量偏大",
      "如果同时有心慌、出汗、发抖，不要等复查，及时就医"],
  dept:["内分泌科"],
  g:"q", forDis:["dm","fld"] },
...
{ k:"glucose_hba1c", n:"糖化血红蛋白", cat:"血糖", spec:"whole_blood",
  ...
  hi:["近 2–3 个月平均血糖偏高，不是某一天吃多了","降糖方案需要调整",
      "贫血、近期输血、血红蛋白异常时结果会失真，要结合血常规看"],
  dept:["内分泌科"],
  g:"q", forDis:["dm"] },
...
{ k:"liver_alt", n:"谷丙转氨酶 ALT", cat:"肝功能", spec:"serum",
  ...
  hi:["脂肪肝（体检人群里最常见的原因）","近期饮酒","在吃的药物或保健品的影响，别自己停药，问医生",
      "病毒性肝炎","抽血前几天剧烈运动或熬夜"],
  dept:["消化内科","感染科"],
...
{ k:"liver_ast", n:"谷草转氨酶 AST", cat:"肝功能", spec:"serum",
  ...
  max:40, hard:120, t:"< 40",
  hi:["抽血前几天剧烈运动（它不只来自肝，肌肉也有）","脂肪肝","饮酒（酒精性肝损时它常比 ALT 更高）",
      "在吃的药物影响","如果同时有胸闷胸痛，要排查心肌问题"],
  dept:["消化内科","感染科"],
  g:"q", forDis:["fld","hbv"] },
...
{ k:"liver_ggt", n:"谷氨酰转肽酶 GGT", cat:"肝功能", spec:"serum",
  ...
  hints:["肝功能","生化"],
  exp:"对酒精和胆道问题特别敏感。",
  max:60, hard:180, t:"< 60",
  hi:["饮酒（它对酒精最敏感，单独它高时先想这个）","脂肪肝","胆囊或胆管的问题，尤其和 ALP 一起高时",
      "某些药物（抗癫痫药等）会让它升高但并不代表肝损"],
  dept:["消化内科","肝胆外科"],
  g:"q", forDis:["fld","hbv"] },
...
{ k:"liver_tbil", n:"总胆红素", cat:"肝功能", spec:"serum",
  ...
  max:23, t:"≤ 23",
  hi:["Gilbert 综合征这类良性体质 —— 熬夜、饿肚子、感冒时会更明显，转氨酶正常时多半是它",
      "胆道排泄不畅（多半 DBIL 和 ALP 会一起高）","肝细胞损伤","溶血",
      "如果眼白或皮肤发黄、尿色变深，别等复查，尽快就医"],
  dept:["消化内科","肝胆外科"],
  g:"q", forDis:["fld","hbv"] },
...
{ k:"liver_alp", n:"碱性磷酸酶 ALP", cat:"肝功能", spec:"serum",
  ...
  min:45, max:125, t:"45 – 125",
  hi:["胆道排泄不畅，尤其和 GGT 一起高时","骨骼相关情况（骨折愈合期、维生素 D 缺乏、青少年生长期）",
      "妊娠期会生理性升高"],
  lo:["单独偏低通常没有临床意义","少数见于严重营养不良、锌缺乏或甲状腺功能减退"],
  dept:["消化内科","肝胆外科"],
  g:"q", forDis:["fld","hbv"] },
...
{ k:"liver_dbil", n:"直接胆红素 DBIL", cat:"肝功能", spec:"serum",
  ...
  exp:"升高更多指向胆道排泄环节的问题。",
  max:8, t:"< 8",
  hi:["胆道排泄环节受阻（结石、炎症等）","肝细胞损伤",
      "它比间接胆红素更值得重视：单独它高时，Gilbert 这类良性解释就不成立了"],
  dept:["消化内科","肝胆外科"],
  g:"q", forDis:["fld","hbv"] },
...
{ k:"liver_ibil", n:"间接胆红素 IBIL", cat:"肝功能", spec:"serum",
  ...
  max:16, t:"< 16",
  hi:["Gilbert 综合征这类良性体质，是最常见的解释","熬夜、饥饿、劳累、感冒后会更明显",
      "溶血（此时血红蛋白通常会同时偏低）"],
  dept:["消化内科","血液科"],
  g:"q", forDis:["fld","hbv"] },
...
{ k:"liver_tba", n:"总胆汁酸 TBA", cat:"肝功能", spec:"serum",
  ...
  max:10, t:"< 10",
  hi:["抽血前没空腹（餐后本来就会升高，先确认这条）","胆汁淤积","肝细胞损伤"],
  dept:["消化内科","肝胆外科"],
  g:"q", forDis:["fld","hbv"] },
...
{ k:"liver_tp", n:"总蛋白 TP", cat:"肝功能", spec:"serum",
  ...
  exp:"白蛋白加球蛋白。",
  min:65, max:85, t:"65 – 85",
  hi:["抽血时脱水会让它假性升高","慢性炎症或免疫活动（此时球蛋白通常同时高）"],
  lo:["营养摄入不足","肝脏合成能力下降","肾脏或消化道丢蛋白",
      "要看是白蛋白低还是球蛋白低，两者含义完全不同"],
  dept:["消化内科","肾内科"],
  g:"q", forDis:["fld","hbv","ckd"] },

{ k:"liver_alb", n:"白蛋白 ALB", cat:"肝功能", spec:"serum",
  u:"g/L", units:["g/L","g/dL"], vt:"numeric", trend:true,
  alias:["ALB","白蛋白","血清白蛋白","清蛋白"], hints:["肝功能","生化"],
  exp:"肝脏合成能力的核心指标，长期偏低要同时考虑营养和肾脏丢失。",
  min:40, max:55, t:"40 – 55",
  hi:["基本只见于抽血时脱水，本身不是病"],
  lo:["蛋白质摄入不足","肝脏合成能力下降","肾脏漏蛋白（查一下尿蛋白）","慢性炎症或消耗状态",
      "如果同时有下肢水肿，要尽快找医生"],
  dept:["消化内科","肾内科"],
  g:"q", forDis:["fld","hbv","ckd"] },
...
{ k:"liver_glb", n:"球蛋白 GLB", cat:"肝功能", spec:"serum",
  ...
  exp:"慢性炎症和免疫活动时升高。",
  min:20, max:35, t:"20 – 35",
  hi:["慢性炎症或近期感染","慢性肝病","自身免疫或血液系统情况（持续明显升高才需要查）"],
  lo:["免疫球蛋白偏低，反复感染时才有意义","单次轻度偏低通常不必紧张"],
  dept:["消化内科","血液科"],
  g:"q", forDis:["fld","hbv"] },
...
{ k:"liver_palb", n:"前白蛋白 PALB", cat:"肝功能", spec:"serum",
  ...
  min:200, max:400, t:"200 – 400",
  hi:["单独偏高通常没有临床意义"],
  lo:["近期进食少或营养不足","肝脏合成能力下降","近期有炎症或感染时会一过性下降",
      "它变化快，比白蛋白更早反应，单次偏低先看看最近吃得怎么样"],
  dept:["消化内科","营养科"],
  g:"q", forDis:["fld","hbv"] },
...
{ k:"thyroid_tsh", n:"促甲状腺素 TSH", cat:"甲状腺功能", spec:"serum",
  ...
  /* TSH 是反着来的：它高说明甲状腺功能低。这条最容易被外行读反，所以放第一句。 */
  hi:["它高 = 甲状腺功能偏低（方向是反的，别读反了）","在吃优甲乐但剂量不够或漏服",
      "桥本甲状腺炎等自身免疫性甲状腺病","近期用过含碘造影剂或胺碘酮"],
  lo:["它低 = 甲状腺激素偏多","优甲乐剂量偏大（术后为压制复发而刻意压低的除外）",
      "甲亢","如果同时有心慌、手抖、消瘦、怕热，尽快就诊"],
  dept:["内分泌科"],
...
{ k:"thyroid_ft3", n:"游离 T3", cat:"甲状腺功能", spec:"serum",
  ...
  exp:"活性最强的甲状腺激素。",
  min:3.1, max:6.8, t:"3.1 – 6.8",
  hi:["甲状腺激素偏多（甲亢，或替代治疗剂量偏大）"],
  lo:["甲状腺功能减退","严重疾病或长期营养不良时会单独下降，此时并不代表甲状腺本身有问题"],
  dept:["内分泌科"],
  g:"h", forDis:["thyca","hypo"] },
...
{ k:"thyroid_ft4", n:"游离 T4", cat:"甲状腺功能", spec:"serum",
  ...
  exp:"甲状腺激素的主要储备形式。",
  min:12, max:22, t:"12 – 22",
  hi:["优甲乐剂量偏大（最常见）","甲亢","抽血当天早上吃过优甲乐会让结果偏高，建议抽完血再吃"],
  lo:["甲状腺功能减退","优甲乐剂量不够或吸收不好（和钙片、铁剂间隔不足 4 小时会影响吸收）"],
  dept:["内分泌科"],
  g:"h", forDis:["thyca","hypo"] },
...
{ k:"thyroid_t3", n:"总 T3", cat:"甲状腺功能", spec:"serum",
  ...
  min:1.3, max:3.1, t:"1.3 – 3.1",
  hi:["甲状腺激素偏多","妊娠或口服雌激素会让结合蛋白升高，从而抬高总量，但游离的 FT3 正常"],
  lo:["甲状腺功能减退","蛋白水平低时会跟着低，此时看 FT3 更准"],
  dept:["内分泌科"],
  g:"h", forDis:["thyca","hypo"] },
...
{ k:"thyroid_t4", n:"总 T4", cat:"甲状腺功能", spec:"serum",
  ...
  exp:"同上，主要作参考。",
  min:66, max:181, t:"66 – 181",
  hi:["甲状腺激素偏多","妊娠或口服雌激素抬高结合蛋白，此时看 FT4 更准"],
  lo:["甲状腺功能减退","蛋白水平低时会跟着低，此时看 FT4 更准"],
  dept:["内分泌科"],
  g:"h", forDis:["thyca","hypo"] },
...
{ k:"thyroid_tg", n:"甲状腺球蛋白 Tg", cat:"甲状腺功能", spec:"serum",
  ...
  /* 术后随访场景下这条最要紧的不是「高了是什么」，而是「必须连着看趋势、
     且必须同时看 TgAb」—— 单点数值容易误导。 */
  hi:["甲状腺还在的人，结节、炎症都可能让它升高，不等于有问题",
      "全切术后升高，或连续几次持续上升，要及时找手术科室复查",
      "看它必须同时看 TgAb：TgAb 阳性会让 Tg 测得假性偏低，两个要一起解读",
      "不同医院试剂不同，换医院查的数值不能直接比大小"],
  dept:["内分泌科","甲状腺外科"],
  g:"h", forDis:["thyca"] },
...
{ k:"thyroid_tgab", n:"抗甲状腺球蛋白抗体 TgAb", cat:"甲状腺功能", spec:"serum",
  ...
  max:115, t:"< 115",
  hi:["桥本甲状腺炎等自身免疫性甲状腺病，人群里相当常见","它一旦阳性，同次的 Tg 结果要打折扣看",
      "术后随访时，它本身的变化趋势也能当作参考线索"],
  dept:["内分泌科","甲状腺外科"],
  g:"h", forDis:["thyca","hypo"] },
